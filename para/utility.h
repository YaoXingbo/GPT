...
#include "detail_msgs/cloud_info.h"
...
extern const float lidarMinRange = 4.0;
extern const float lidarMaxRange = 100.0;

extern const bool loopClosureEnableFlag = true;
extern const double mappingProcessInterval = 0.05;

extern const float scanPeriod = 0.1;
extern const int systemDelay = 0;
extern const int imuQueLength = 100;
extern const string imuTopic = "/IMU_data";


extern const float sensorMountAngle = 0.0;
extern const float segmentTheta = 30.0/180.0*M_PI;
...
extern const float surroundingKeyframeSearchRadius = 90.0;
extern const int   surroundingKeyframeSearchNum = 60;  //最新的60个
